...
public final class ReflectiveTypeAdapterFactory implements TypeAdapterFactory {
    ...
    private BoundField createBoundField(Gson context, Field field, String name, TypeToken<?> fieldType, boolean serialize, boolean deserialize) {
        ...
        C02621 r0 = new BoundField(name, serialize, deserialize) {
            /* access modifiers changed from: 0000 */
            ...
            while (i < length) {
                ...
                if (serialize || deserialize) {
                    ...
                    while (i2 < size) {
                        ...
                        Field field2 = field;
                        replaced = (BoundField) result.put(name2, createBoundField(context, field, name2, TypeToken.get(fieldType), serialize2, deserialize));
                        if (previous == null) {
                            BoundField boundField = replaced;
                        } else {
                            replaced = previous;
                        }
                        i2 = i3 + 1;
