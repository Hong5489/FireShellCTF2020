...
public final class TypeAdapters {
    ...
    public static final TypeAdapter<BitSet> BIT_SET = new TypeAdapter<BitSet>() {
        public BitSet read(JsonReader in) throws IOException {
            ...
            while (tokenType != JsonToken.END_ARRAY) {
                int i2 = C029736.$SwitchMap$com$google$gson$stream$JsonToken[tokenType.ordinal()];
                boolean set = false;
                if (i2 != 1) {
                    if (i2 == 2) {
                        set = in.nextBoolean();
    ...
    public static final TypeAdapter<JsonElement> JSON_ELEMENT = new TypeAdapter<JsonElement>() {
        public JsonElement read(JsonReader in) throws IOException {
            switch (C029736.$SwitchMap$com$google$gson$stream$JsonToken[in.peek().ordinal()]) {
                case 1:
    ...
    public static final TypeAdapter<Number> NUMBER = new TypeAdapter<Number>() {
        public Number read(JsonReader in) throws IOException {
            ...
            int i = C029736.$SwitchMap$com$google$gson$stream$JsonToken[jsonToken.ordinal()];
            if (i == 1 || i == 3) {
    ...
    static /* synthetic */ class C029736 {
    ...
    public static <TT> TypeAdapterFactory newFactory(final Class<TT> unboxed, final Class<TT> boxed, final TypeAdapter<? super TT> typeAdapter) {
        return new TypeAdapterFactory() {
            ...
            public String toString() {
                StringBuilder sb = new StringBuilder();
                sb.append("Factory[type=");
                sb.append(boxed.getName());
                sb.append("+");
                sb.append(unboxed.getName());
                sb.append(",adapter=");
                sb.append(typeAdapter);
                sb.append("]");
                return sb.toString();
