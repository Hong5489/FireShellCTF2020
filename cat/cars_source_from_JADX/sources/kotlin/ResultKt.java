...
public final class ResultKt {
    ...
    public static final void throwOnFailure(Object $this$throwOnFailure) {
        if ($this$throwOnFailure instanceof Failure) {
            throw ((Failure) $this$throwOnFailure).exception;
        }
    }
    ...
    private static final <R> Object runCatching(Function0<? extends R> block) {
        try {
            ...
            return Result.m47constructorimpl(createFailure(e));
        }
    }
    ...
    private static final <T, R> Object runCatching(T $this$runCatching, Function1<? super T, ? extends R> block) {
        try {
            Companion companion = Result.Companion;
            return Result.m47constructorimpl(block.invoke($this$runCatching));
        } catch (Throwable e) {
            Companion companion2 = Result.Companion;
            return Result.m47constructorimpl(createFailure(e));
        }
    ...
    private static final <R, T extends R> R getOrElse(Object $this$getOrElse, Function1<? super Throwable, ? extends R> onFailure) {
        Throwable exception = Result.m50exceptionOrNullimpl($this$getOrElse);
        if (exception == null) {
    ...
    private static final <R, T extends R> R getOrDefault(Object $this$getOrDefault, R defaultValue) {
        if (Result.m53isFailureimpl($this$getOrDefault)) {
            return defaultValue;
        }
    ...
    private static final <R, T> R fold(Object $this$fold, Function1<? super T, ? extends R> onSuccess, Function1<? super Throwable, ? extends R> onFailure) {
        Throwable exception = Result.m50exceptionOrNullimpl($this$fold);
        if (exception == null) {
    ...
    private static final <R, T> Object map(Object $this$map, Function1<? super T, ? extends R> transform) {
        if (!Result.m54isSuccessimpl($this$map)) {
            return Result.m47constructorimpl($this$map);
        }
        Companion companion = Result.Companion;
        return Result.m47constructorimpl(transform.invoke($this$map));
    }

    private static final <R, T> Object mapCatching(Object $this$mapCatching, Function1<? super T, ? extends R> transform) {
        if (!Result.m54isSuccessimpl($this$mapCatching)) {
            return Result.m47constructorimpl($this$mapCatching);
        }
        try {
            Companion companion = Result.Companion;
            return Result.m47constructorimpl(transform.invoke($this$mapCatching));
        } catch (Throwable th) {
            Companion companion2 = Result.Companion;
            return Result.m47constructorimpl(createFailure(th));
        }
    }

    private static final <R, T extends R> Object recover(Object $this$recover, Function1<? super Throwable, ? extends R> transform) {
        Throwable exception = Result.m50exceptionOrNullimpl($this$recover);
        if (exception == null) {
            return $this$recover;
        }
        Companion companion = Result.Companion;
        return Result.m47constructorimpl(transform.invoke(exception));
    }
    ...
    private static final <R, T extends R> Object recoverCatching(Object $this$recoverCatching, Function1<? super Throwable, ? extends R> transform) {
        ...
        Throwable exception = Result.m50exceptionOrNullimpl($this$recoverCatching);
        if (exception == null) {
    ...
    private static final <T> Object onFailure(Object $this$onFailure, Function1<? super Throwable, Unit> action) {
        Throwable it = Result.m50exceptionOrNullimpl($this$onFailure);
        if (it != null) {
            action.invoke(it);
        }
    ...
    private static final <T> Object onSuccess(Object $this$onSuccess, Function1<? super T, Unit> action) {
        if (Result.m54isSuccessimpl($this$onSuccess)) {
