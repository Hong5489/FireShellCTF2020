...
final class RealBufferedSource implements BufferedSource {
    ...
    public String readUtf8LineStrict(long limit) throws IOException {
        ...
        if (j >= 0) {
            ...
            if (scanLength < LongCompanionObject.MAX_VALUE && request(scanLength) && this.buffer.getByte(scanLength - 1) == 13 && request(1 + scanLength) && this.buffer.getByte(scanLength) == 10) {
