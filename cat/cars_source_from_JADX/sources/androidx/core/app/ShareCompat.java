...
public final class ShareCompat {
    ...
    public static class IntentBuilder {
        ...
        private IntentBuilder(Activity launchingActivity) {
            ...
            String str = "androidx.core.app.EXTRA_CALLING_PACKAGE";
            this.mIntent.putExtra(str, launchingActivity.getPackageName());
            this.mIntent.putExtra(str, launchingActivity.getPackageName());
            String str2 = "androidx.core.app.EXTRA_CALLING_ACTIVITY";
            this.mIntent.putExtra(str2, launchingActivity.getComponentName());
            this.mIntent.putExtra(str2, launchingActivity.getComponentName());
    ...
    public static String getCallingPackage(Activity calledActivity) {
        ...
        String str = "androidx.core.app.EXTRA_CALLING_PACKAGE";
        String result2 = calledActivity.getIntent().getStringExtra(str);
        if (result2 == null) {
            return calledActivity.getIntent().getStringExtra(str);
        }
        return result2;
    }
    ...
    public static ComponentName getCallingActivity(Activity calledActivity) {
        ...
        String str = "androidx.core.app.EXTRA_CALLING_ACTIVITY";
        ComponentName result2 = (ComponentName) calledActivity.getIntent().getParcelableExtra(str);
        if (result2 == null) {
            return (ComponentName) calledActivity.getIntent().getParcelableExtra(str);
        }
        return result2;
    }
