...
public class ConstraintWidget {
    ...
    static /* synthetic */ class C00931 {
        ...
        static final /* synthetic */ int[] f16xdde91696 = new int[DimensionBehaviour.values().length];

        static {
            try {
                f16xdde91696[DimensionBehaviour.FIXED.ordinal()] = 1;
            ...
            f15x4c44d048 = new int[Type.values().length];
            try {
                f15x4c44d048[Type.LEFT.ordinal()] = 1;
            } catch (NoSuchFieldError e5) {
            }
            try {
                f15x4c44d048[Type.TOP.ordinal()] = 2;
            } catch (NoSuchFieldError e6) {
            }
            try {
                f15x4c44d048[Type.RIGHT.ordinal()] = 3;
            } catch (NoSuchFieldError e7) {
            }
            try {
                f15x4c44d048[Type.BOTTOM.ordinal()] = 4;
            } catch (NoSuchFieldError e8) {
            }
            try {
                f15x4c44d048[Type.BASELINE.ordinal()] = 5;
            } catch (NoSuchFieldError e9) {
            }
            try {
                f15x4c44d048[Type.CENTER.ordinal()] = 6;
            } catch (NoSuchFieldError e10) {
            }
            try {
                f15x4c44d048[Type.CENTER_X.ordinal()] = 7;
            } catch (NoSuchFieldError e11) {
            }
            try {
                f15x4c44d048[Type.CENTER_Y.ordinal()] = 8;
            } catch (NoSuchFieldError e12) {
            }
            try {
                f15x4c44d048[Type.NONE.ordinal()] = 9;
    ...
    public void setGoneMargin(Type type, int goneMargin) {
        int i = C00931.f15x4c44d048[type.ordinal()];
        if (i == 1) {
    ...
    public void setDrawOrigin(int x, int y) {
        ...
        this.f13mX = this.mDrawX;
        this.f14mY = this.mDrawY;
    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:153:0x02e5  */
    /* JADX WARNING: Removed duplicated region for block: B:154:0x02ee  */
    /* JADX WARNING: Removed duplicated region for block: B:157:0x02f4  */
    ...
    private void applyConstraints(LinearSystem system, boolean parentWrapContent, SolverVariable parentMin, SolverVariable parentMax, DimensionBehaviour dimensionBehaviour, boolean wrapContent, ConstraintAnchor beginAnchor, ConstraintAnchor endAnchor, int beginPosition, int dimension, int minDimension, int maxDimension, float bias, boolean useRatio, boolean inChain, int matchConstraintDefault, int matchMinDimension, int matchMaxDimension, float matchPercentDimension, boolean applyPosition) {
        ...
        int i7 = C00931.f16xdde91696[dimensionBehaviour.ordinal()];
