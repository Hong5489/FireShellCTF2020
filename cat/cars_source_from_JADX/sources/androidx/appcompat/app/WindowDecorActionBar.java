...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0393R.C0395id.decor_content_parent);
        ActionBarOverlayLayout actionBarOverlayLayout = this.mOverlayLayout;
        if (actionBarOverlayLayout != null) {
            actionBarOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0393R.C0395id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0393R.C0395id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0393R.C0395id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0393R.styleable.ActionBar, C0393R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0393R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0393R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0393R.attr.actionBarWidgetTheme, outValue, true);
