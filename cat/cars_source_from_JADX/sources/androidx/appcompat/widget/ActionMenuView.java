    ...
    private void onMeasureExactFormat(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        while (true) {
            ...
            if (child.getVisibility() == 8) {
                ...
                int cellsUsed = measureChildForCells(child, cellSize2, lp.isOverflowButton ? 1 : cellsRemaining2, itemHeightSpec, heightPadding2);
                ...
                while (i9 < childCount) {
                    ...
                    if ((minCellsAt & ((long) (1 << i9))) != 0) {
                        if (centerSingleExpandedItem && lp3.preventEdgeOffset && cellsRemaining2 == 1) {
                            ...
                            child3.setPadding(i10 + cellSize2, 0, i10, 0);
                        }
                        lp3.cellsUsed++;
                        lp3.expanded = true;
                        cellsRemaining2--;
        ...
        maxChildHeight = maxChildHeight2;
        needsExpansion = needsExpansion2;
        int singleItem = !hasOverflow && visibleItemCount == 1;
        if (cellsRemaining2 <= 0 || smallestItemsAt == 0) {
            cellSize = cellSize2;
            int cellSize3 = singleItem;
        } else if (cellsRemaining2 < visibleItemCount - 1 || singleItem != 0 || maxCellsUsed > 1) {
            ...
            int extraPixels = expandCount > 0.0f ? (int) (((float) (cellsRemaining2 * cellSize)) / expandCount) : i;
            int i13 = 0;
            while (i13 < childCount) {
                ...
                if ((smallestItemsAt & ((long) (1 << i13))) != 0) {
                    ...
                    if (child4 instanceof ActionMenuItemView) {
                        ...
                        lp4.expanded = true;
                        if (i13 == 0 && !lp4.preventEdgeOffset) {
