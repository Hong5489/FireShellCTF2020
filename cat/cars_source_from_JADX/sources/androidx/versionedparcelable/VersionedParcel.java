...
public abstract class VersionedParcel {
    ...
    protected static <T extends VersionedParcelable> T readFromParcel(String parcelCls, VersionedParcel versionedParcel) {
        ...
        try {
            return (VersionedParcelable) Class.forName(parcelCls, true, cls.getClassLoader()).getDeclaredMethod("read", new Class[]{cls}).invoke(null, new Object[]{versionedParcel});
