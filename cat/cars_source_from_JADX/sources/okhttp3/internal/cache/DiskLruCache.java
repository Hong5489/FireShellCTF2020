...
public final class DiskLruCache implements Closeable, Flushable {
        ...
        public Sink newSink(int index) {
            synchronized (DiskLruCache.this) {
                if (this.done) {
                    ...
                    try {
                        C03461 r3 = new FaultHidingSink(DiskLruCache.this.fileSystem.sink(this.entry.dirtyFiles[index])) {
    ...
    private void readJournal() throws java.io.IOException {
        /*
            ...
            boolean r7 = r7.equals(r2)     // Catch:{ all -> 0x00ae }
            if (r7 == 0) goto L_0x0080
            java.lang.String r7 = "1"
            boolean r7 = r7.equals(r3)     // Catch:{ all -> 0x00ae }
            if (r7 == 0) goto L_0x0080
            int r7 = r10.appVersion     // Catch:{ all -> 0x00ae }
            java.lang.String r7 = java.lang.Integer.toString(r7)     // Catch:{ all -> 0x00ae }
            boolean r7 = r7.equals(r4)     // Catch:{ all -> 0x00ae }
            if (r7 == 0) goto L_0x0080
            int r7 = r10.valueCount     // Catch:{ all -> 0x00ae }
            java.lang.String r7 = java.lang.Integer.toString(r7)     // Catch:{ all -> 0x00ae }
            boolean r7 = r7.equals(r5)     // Catch:{ all -> 0x00ae }
            if (r7 == 0) goto L_0x0080
            java.lang.String r7 = ""
            ...
            r0 = 0
        L_0x0053:
            java.lang.String r7 = r1.readUtf8LineStrict()     // Catch:{ EOFException -> 0x005d }
            r10.readJournalLine(r7)     // Catch:{ EOFException -> 0x005d }
            int r0 = r0 + 1
            goto L_0x0053
        L_0x005d:
            r7 = move-exception
            java.util.LinkedHashMap<java.lang.String, okhttp3.internal.cache.DiskLruCache$Entry> r7 = r10.lruEntries     // Catch:{ all -> 0x00ae }
            int r7 = r7.size()     // Catch:{ all -> 0x00ae }
            int r7 = r0 - r7
            r10.redundantOpCount = r7     // Catch:{ all -> 0x00ae }
            boolean r7 = r1.exhausted()     // Catch:{ all -> 0x00ae }
            if (r7 != 0) goto L_0x0073
            r10.rebuildJournal()     // Catch:{ all -> 0x00ae }
            goto L_0x0079
        L_0x0073:
            okio.BufferedSink r7 = r10.newJournalWriter()     // Catch:{ all -> 0x00ae }
            r10.journalWriter = r7     // Catch:{ all -> 0x00ae }
        L_0x0079:
        ...
        L_0x0080:
            ...
            r8.append(r9)     // Catch:{ all -> 0x00ae }
            r8.append(r2)     // Catch:{ all -> 0x00ae }
            r8.append(r0)     // Catch:{ all -> 0x00ae }
            r8.append(r3)     // Catch:{ all -> 0x00ae }
            r8.append(r0)     // Catch:{ all -> 0x00ae }
            r8.append(r5)     // Catch:{ all -> 0x00ae }
            r8.append(r0)     // Catch:{ all -> 0x00ae }
            r8.append(r6)     // Catch:{ all -> 0x00ae }
            java.lang.String r0 = "]"
            r8.append(r0)     // Catch:{ all -> 0x00ae }
            java.lang.String r0 = r8.toString()     // Catch:{ all -> 0x00ae }
    ...
    public synchronized okhttp3.internal.cache.DiskLruCache.Editor edit(java.lang.String r6, long r7) throws java.io.IOException {
        /*
            ...
            long r3 = r0.sequenceNumber     // Catch:{ all -> 0x0075 }
        ...
        L_0x0034:
            ...
            okio.BufferedSink r1 = r1.writeUtf8(r3)     // Catch:{ all -> 0x0075 }
            r3 = 32
            okio.BufferedSink r1 = r1.writeByte(r3)     // Catch:{ all -> 0x0075 }
            okio.BufferedSink r1 = r1.writeUtf8(r6)     // Catch:{ all -> 0x0075 }
            r3 = 10
            r1.writeByte(r3)     // Catch:{ all -> 0x0075 }
            okio.BufferedSink r1 = r5.journalWriter     // Catch:{ all -> 0x0075 }
        ...
        L_0x006c:
            ...
            r1.execute(r3)     // Catch:{ all -> 0x0075 }
            monitor-exit(r5)
            return r2
        L_0x0075:
            r6 = move-exception
    ...
    public synchronized void completeEdit(okhttp3.internal.cache.DiskLruCache.Editor r11, boolean r12) throws java.io.IOException {
        /*
            r10 = this;
            monitor-enter(r10)
            okhttp3.internal.cache.DiskLruCache$Entry r0 = r11.entry     // Catch:{ all -> 0x00fc }
            ...
            r2 = r1
        L_0x000f:
            int r3 = r10.valueCount     // Catch:{ all -> 0x00fc }
            if (r2 >= r3) goto L_0x0047
            boolean[] r3 = r11.written     // Catch:{ all -> 0x00fc }
            boolean r3 = r3[r2]     // Catch:{ all -> 0x00fc }
            if (r3 == 0) goto L_0x002d
            okhttp3.internal.io.FileSystem r3 = r10.fileSystem     // Catch:{ all -> 0x00fc }
            java.io.File[] r4 = r0.dirtyFiles     // Catch:{ all -> 0x00fc }
            r4 = r4[r2]     // Catch:{ all -> 0x00fc }
            boolean r3 = r3.exists(r4)     // Catch:{ all -> 0x00fc }
            if (r3 != 0) goto L_0x002a
            r11.abort()     // Catch:{ all -> 0x00fc }
            monitor-exit(r10)
            return
        L_0x002a:
            int r2 = r2 + 1
        ...
        L_0x002d:
            r11.abort()     // Catch:{ all -> 0x00fc }
            java.lang.IllegalStateException r1 = new java.lang.IllegalStateException     // Catch:{ all -> 0x00fc }
            ...
            r1.<init>(r3)     // Catch:{ all -> 0x00fc }
            throw r1     // Catch:{ all -> 0x00fc }
        L_0x0047:
        L_0x0048:
            int r2 = r10.valueCount     // Catch:{ all -> 0x00fc }
            if (r1 >= r2) goto L_0x0080
            java.io.File[] r2 = r0.dirtyFiles     // Catch:{ all -> 0x00fc }
            r2 = r2[r1]     // Catch:{ all -> 0x00fc }
            if (r12 == 0) goto L_0x0078
            okhttp3.internal.io.FileSystem r3 = r10.fileSystem     // Catch:{ all -> 0x00fc }
            boolean r3 = r3.exists(r2)     // Catch:{ all -> 0x00fc }
            if (r3 == 0) goto L_0x007d
            java.io.File[] r3 = r0.cleanFiles     // Catch:{ all -> 0x00fc }
            r3 = r3[r1]     // Catch:{ all -> 0x00fc }
            okhttp3.internal.io.FileSystem r4 = r10.fileSystem     // Catch:{ all -> 0x00fc }
            r4.rename(r2, r3)     // Catch:{ all -> 0x00fc }
            long[] r4 = r0.lengths     // Catch:{ all -> 0x00fc }
            r4 = r4[r1]     // Catch:{ all -> 0x00fc }
            okhttp3.internal.io.FileSystem r6 = r10.fileSystem     // Catch:{ all -> 0x00fc }
            long r6 = r6.size(r3)     // Catch:{ all -> 0x00fc }
            long[] r8 = r0.lengths     // Catch:{ all -> 0x00fc }
            r8[r1] = r6     // Catch:{ all -> 0x00fc }
            long r8 = r10.size     // Catch:{ all -> 0x00fc }
            long r8 = r8 - r4
            long r8 = r8 + r6
            r10.size = r8     // Catch:{ all -> 0x00fc }
            goto L_0x007d
        L_0x0078:
            okhttp3.internal.io.FileSystem r3 = r10.fileSystem     // Catch:{ all -> 0x00fc }
            r3.delete(r2)     // Catch:{ all -> 0x00fc }
        L_0x007d:
            int r1 = r1 + 1
            goto L_0x0048
        L_0x0080:
            int r1 = r10.redundantOpCount     // Catch:{ all -> 0x00fc }
            r2 = 1
            int r1 = r1 + r2
            r10.redundantOpCount = r1     // Catch:{ all -> 0x00fc }
            r1 = 0
            r0.currentEditor = r1     // Catch:{ all -> 0x00fc }
            boolean r1 = r0.readable     // Catch:{ all -> 0x00fc }
            r1 = r1 | r12
            r3 = 10
            r4 = 32
            if (r1 == 0) goto L_0x00bc
            r0.readable = r2     // Catch:{ all -> 0x00fc }
            okio.BufferedSink r1 = r10.journalWriter     // Catch:{ all -> 0x00fc }
            java.lang.String r2 = "CLEAN"
            okio.BufferedSink r1 = r1.writeUtf8(r2)     // Catch:{ all -> 0x00fc }
            r1.writeByte(r4)     // Catch:{ all -> 0x00fc }
            okio.BufferedSink r1 = r10.journalWriter     // Catch:{ all -> 0x00fc }
            java.lang.String r2 = r0.key     // Catch:{ all -> 0x00fc }
            r1.writeUtf8(r2)     // Catch:{ all -> 0x00fc }
            okio.BufferedSink r1 = r10.journalWriter     // Catch:{ all -> 0x00fc }
            r0.writeLengths(r1)     // Catch:{ all -> 0x00fc }
            okio.BufferedSink r1 = r10.journalWriter     // Catch:{ all -> 0x00fc }
            r1.writeByte(r3)     // Catch:{ all -> 0x00fc }
            if (r12 == 0) goto L_0x00da
            long r1 = r10.nextSequenceNumber     // Catch:{ all -> 0x00fc }
            r3 = 1
            long r3 = r3 + r1
            r10.nextSequenceNumber = r3     // Catch:{ all -> 0x00fc }
            r0.sequenceNumber = r1     // Catch:{ all -> 0x00fc }
            goto L_0x00da
        L_0x00bc:
            java.util.LinkedHashMap<java.lang.String, okhttp3.internal.cache.DiskLruCache$Entry> r1 = r10.lruEntries     // Catch:{ all -> 0x00fc }
            java.lang.String r2 = r0.key     // Catch:{ all -> 0x00fc }
            r1.remove(r2)     // Catch:{ all -> 0x00fc }
            okio.BufferedSink r1 = r10.journalWriter     // Catch:{ all -> 0x00fc }
        ...
        L_0x00da:
            okio.BufferedSink r1 = r10.journalWriter     // Catch:{ all -> 0x00fc }
            r1.flush()     // Catch:{ all -> 0x00fc }
            long r1 = r10.size     // Catch:{ all -> 0x00fc }
            long r3 = r10.maxSize     // Catch:{ all -> 0x00fc }
            int r1 = (r1 > r3 ? 1 : (r1 == r3 ? 0 : -1))
            if (r1 > 0) goto L_0x00ed
            boolean r1 = r10.journalRebuildRequired()     // Catch:{ all -> 0x00fc }
            if (r1 == 0) goto L_0x00f4
        L_0x00ed:
            java.util.concurrent.Executor r1 = r10.executor     // Catch:{ all -> 0x00fc }
            java.lang.Runnable r2 = r10.cleanupRunnable     // Catch:{ all -> 0x00fc }
            r1.execute(r2)     // Catch:{ all -> 0x00fc }
        L_0x00f4:
            monitor-exit(r10)
            return
        L_0x00f6:
    ...
    public synchronized boolean remove(java.lang.String r8) throws java.io.IOException {
        /*
            ...
            java.util.LinkedHashMap<java.lang.String, okhttp3.internal.cache.DiskLruCache$Entry> r0 = r7.lruEntries     // Catch:{ all -> 0x0029 }
            java.lang.Object r0 = r0.get(r8)     // Catch:{ all -> 0x0029 }
            ...
            return r1
        L_0x0017:
            boolean r2 = r7.removeEntry(r0)     // Catch:{ all -> 0x0029 }
            if (r2 == 0) goto L_0x0027
            long r3 = r7.size     // Catch:{ all -> 0x0029 }
            long r5 = r7.maxSize     // Catch:{ all -> 0x0029 }
