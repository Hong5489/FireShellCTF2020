...
final class Http2Reader implements Closeable {
    ...
    private void readHeaders(Handler handler, int length, byte flags, int streamId) throws IOException {
        ...
        if (streamId != 0) {
            ...
            if ((flags & 8) != 0) {
                padding = (short) (this.source.readByte() & UByte.MAX_VALUE);
            }
            if ((flags & 32) != 0) {
    ...
    private void readPriority(Handler handler, int streamId) throws IOException {
        ...
        handler.priority(streamId, Integer.MAX_VALUE & w1, (this.source.readByte() & UByte.MAX_VALUE) + 1, (Integer.MIN_VALUE & w1) != 0);
    }
    ...
    static int readMedium(BufferedSource source2) throws IOException {
        return ((source2.readByte() & UByte.MAX_VALUE) << 16) | ((source2.readByte() & UByte.MAX_VALUE) << 8) | (source2.readByte() & UByte.MAX_VALUE);
    }
